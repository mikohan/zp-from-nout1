...
<div class="cotainer">
	<div class="row">
		...
		<ol class="breadcrumb">
			...
			<li class="active">
				Редактирование короткие статьи
			</li>
		</ol>
				...
				<div class="col-md-3">
					<ul class="nav-stacked">
					    <li role="presentation" >
                            <a href="/admin/lady/editart/"><i class="fa fa-plus adm_green"></i> &nbsp;&nbsp;Добавить короткую статью</a>
                        </li>
					    <?php foreach($data2 as $d) :  ?>
						<li   >
                            <a  class="a_text" onclick="if (! confirm('Точно удалить?')) return false;" href="/admin/lady/deleteart/<?=$d[0] ?>/" data-toggle="tooltip" data-placement="left" title="Удалить новость" ><i class="fa fa-trash-o adm_red"></i> &nbsp;&nbsp;</a><a href="/admin/lady/<?=$d[0] ?>/"> <?=$d[9] ?></a>
                        </li>
						<?php endforeach ; ?>
...
<script>
    ...
    {
       window.location = "/admin/lady/deleteart/<?=$d[0] ?>/";
    }
    else {
