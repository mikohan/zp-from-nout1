                ...
                <div class="col-md-3">
                    <ul class="nav-stacked">
                        <li role="presentation" >
                            <a href="/admin/blondy/editart/"><i class="fa fa-plus adm_green"></i> &nbsp;&nbsp;Добавить блонди</a>
                        </li>
                        <?php foreach($data2 as $d) :  ?>
                        <li   >
                            <a  class="a_text" onclick="if (! confirm('Точно удалить?')) return false;" href="/admin/blondy/deleteart/<?=$d[0] ?>/" data-toggle="tooltip" data-placement="left" title="Удалить новость" ><i class="fa fa-trash-o adm_red"></i> &nbsp;&nbsp;</a><a href="/admin/blondy/<?=$d[0] ?>/"> <?=$d[9] ?></a>
                        </li>
                        <?php endforeach ; ?>
...
<script>
    ...
    {
       window.location = "/admin/blondy/deleteart/<?=$d[0] ?>/";
    }
    else {
