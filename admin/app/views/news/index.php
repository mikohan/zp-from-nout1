				...
				<div class="col-md-3">
					<ul class="nav-stacked">
					    <li role="presentation" >
                            <a href="/admin/news/editart/"><i class="fa fa-plus adm_green"></i> &nbsp;&nbsp;Добавить описаиие</a>
                        </li>
					    <?php foreach($data2 as $d) :  ?>
						<li   >
                            <a  class="a_text" onclick="if (! confirm('Точно удалить?')) return false;" href="/admin/news/deleteart/<?=$d['id'] ?>/" data-toggle="tooltip" data-placement="left" title="Удалить новость" ><i class="fa fa-trash-o adm_red"></i> &nbsp;&nbsp;</a><a href="/admin/news/<?=$d['id'] ?>/"> <?=$d['ang_name'] ?></a>
                        </li>
						<?php endforeach ; ?>
					</ul>
				</div>
...
<input id="angin5" name="author" type="text" class="form-control field2" placeholder="Product ID" value="<?php if(isset($data[0][7])) echo $data[0][7];?>">
