...
<meta property="og:image" content="<?='https://' . $_SERVER['HTTP_HOST'] . '/public/img/articles/' . $data[0]['face_img']?>" />
			...
			<div class="row">
                ...
                <div class="col-md-3">
                    ...
                    <?php foreach ($data2 as $a) { ?>
                           ...
                           <i class="fa fa-book"></i> <a href="/articles/<?=$a['id'] ?>/"><small><?=$a['title'] ?></small></a><br />
