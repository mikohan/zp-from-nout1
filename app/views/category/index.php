...
<?php include ANG_ROOT . "public/tpl/header1.php"?>
        <title>Подбор по каталогу. Категория <?=title(to_low($data2[0]['name']))?> Hyundai Porter <?=title(($data2[0]['id']))?><?=title(($data2[0]['id_h1']))?></title>
				...
				<div class="col-lg-9 col-md-9 col-sm-9">
				    <div class="ang-back">
                        <ul class="breadcrumb">
                            ...
                            <li itemscope itemtype="http://data-vocabulary.org/Breadcrumb">
                                 <a href="<?=ANG_HTTP?>/portercat/" itemprop="url"><span itemprop="title">Каталог</span></a>
                            </li>
							...
							<div class="col-xs-6 col-sm-6 col-md-3">
								...
								<a href="<?=ANG_HTTP?>/catalog/<?=$line['id']?>/" class="thumbnail ang-name" data-toggle="tooltip" data-placement="top" data-original-title="Кликни по картинке категории">
								<img src="/public/img<?= $line['img']?>" alt="<?= $line['name']?> Хендай Портер" title="<?= $line['name']?> Хендай Портер"> 
