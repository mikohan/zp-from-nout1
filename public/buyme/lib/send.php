...
$to = ' zapchastiporter@gmail.com, angara99@gmail.com';
...
function sendSMS ($to, $msg){
	...
	@$r = file_get_contents("https://".$u[$sms["prv"]]);
}

$l["sent"] = "Заказ уже был отправлен";
$l["err"] = "Пожалуйста, заполните все поля";
$l["ok"] = "Спасибо, заказ принят. Ждите звонка";
$l["title"] = "Porter: новый заказ";
$l["footer"] = "<div style=\"background: #f1f1f1; margin-top: 10px; padding: 10px; color: #555;\"><a href='https://zapchastiporter.ru/'>Запчасти Портер</div>";
...
if ($interval < 20) { // если прошло менее (сек)
	...
	if (count($get_data) > 1) { // data to send
		...
		$headers .= "From: hyundaiporter.ru <".$from.">\r\n";
