...
var bmeData = {
	"caption.description": "Чтобы оформить заказ, заполните форму. В течение пары часов с вами свяжется менеджер и уточнит детали заказа, а также время доставки. Отправляя форму Вы соглашаетесь с <br> <a href='/policy/'>политикой конфиденциальности</a></p>", // описание в форме
